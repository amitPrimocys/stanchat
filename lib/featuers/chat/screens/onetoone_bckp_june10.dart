...
//   ) {
//     // 1️⃣ Reserve one extra item at the *top* of the reversed list whenever there's more
...
//         // 2️⃣ If this is the extra “load more” slot, show the loader
//         if (chatProvider.hasMoreMessages && index == messages.length) {
//           return _buildPaginationLoader();
//         }

//         // 3️⃣ Otherwise render a real message
...
//   /// this method is based on total attempt so easy way to check hashmore flag
