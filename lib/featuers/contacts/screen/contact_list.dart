...
import 'package:stanchat/featuers/chat/forward/chat_list_forward_manager.dart';
...
import 'package:stanchat/featuers/contacts/widgets/contact_list_item.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!widget.isForwardMode) {
        ...
        // ✅ Use initializeContacts() - loads from cache instantly, syncs in background
